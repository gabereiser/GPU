...
extern "C"
{
        ...
        GPUBufferCollectionFUCHSIA *collection)
    {
        ...
        *collection = nullptr;
        ...
        const VkResult result = gpuCreateBufferCollectionFUCHSIA(device->handle, createInfo, allocator, &handle);
        ...
        if (wrapper == nullptr)
        {
            gpuDestroyBufferCollectionFUCHSIA(device->handle, handle, allocator);
    ...
    GPU_API void GPU_CALL gpuBufferCollectionFUCHSIADestroy(GPUBufferCollectionFUCHSIA collection)
    {
        ...
        gpuDestroyBufferCollectionFUCHSIA(collection->device->handle, collection->handle, collection->allocator);
