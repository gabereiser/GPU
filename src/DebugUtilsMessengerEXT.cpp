...
extern "C"
{
        ...
        GPUDebugUtilsMessengerEXT *messenger)
    {
        ...
        *messenger = nullptr;
        ...
        const VkResult result = gpuCreateDebugUtilsMessengerEXT(instance->handle, createInfo, allocator, &handle);
        ...
        if (wrapper == nullptr)
        {
            gpuDestroyDebugUtilsMessengerEXT(instance->handle, handle, allocator);
    ...
    GPU_API void GPU_CALL gpuDebugUtilsMessengerEXTDestroy(GPUDebugUtilsMessengerEXT messenger)
    {
        ...
        gpuDestroyDebugUtilsMessengerEXT(messenger->instance->handle, messenger->handle, messenger->allocator);
